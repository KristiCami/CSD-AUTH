...
;; arxiki erotisi ston xristi 
;; arxikopoihsh olon ton gegonoton pou antistoixoun se xaraktiristika se kapoia arxiki timi
...
(defrule ask-spectrometry
  ...
  (bind ?answer (ask-question (str-cat "Ti deixnei h fasmatoskopia gia th molinsh? " "(" (implode$ ?allowed) "):" " ") ?allowed))
